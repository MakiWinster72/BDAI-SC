...
const ACTION_LABELS = {
  ...
  EXPORT_STUDENT_PDF: "导出学生 PDF",
  CREATE_USER: "创建用户",
  UPDATE_USER: "更新用户",
  DELETE_USER: "删除用户",
  UPDATE_TEACHER_CLASSES: "更新教师班级",
  UPDATE_REVIEW_SETTINGS: "更新审核设置",
  UPDATE_SYSTEM_SETTINGS: "更新系统设置",
  UPDATE_UPLOAD_SETTINGS: "更新上传设置",
  REGISTER: "用户注册",
  LOGIN_FAILED: "登录失败",
  CHANGE_PASSWORD: "修改密码",
  SUBMIT_PROFILE_REVIEW: "提交信息审核",
  CANCEL_PROFILE_REVIEW: "撤销信息审核",
  AUTO_APPROVE_PROFILE: "自动通过信息审核",
  APPROVE_PROFILE: "通过信息审核",
  REJECT_PROFILE: "驳回信息审核",
  SUBMIT_ACHIEVEMENT_REVIEW: "提交成就审核",
  CANCEL_ACHIEVEMENT_REVIEW: "撤销成就审核",
  AUTO_APPROVE_ACHIEVEMENT: "自动通过成就审核",
  APPROVE_ACHIEVEMENT: "通过成就审核",
  REJECT_ACHIEVEMENT: "驳回成就审核",
  DIRECT_UPDATE_PROFILE: "直接更新档案",
  ADMIN_UPDATE_PROFILE: "管理员更新档案",
  DIRECT_CREATE_ACHIEVEMENT: "直接创建成就",
  DIRECT_UPDATE_ACHIEVEMENT: "直接更新成就",
  DIRECT_DELETE_ACHIEVEMENT: "直接删除成就",
};
